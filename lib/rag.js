...
export async function processQuery(question, telegramUserId, telegramUsername, wasAudio = false) {
  ...
  if (!matches || matches.length === 0) {
    const noResultResponse = `🤔 No encontré una ordenanza que hable exactamente de eso, pero no te preocupes.

Probá preguntándome de otra forma, por ejemplo:
- _"¿Qué necesito para abrir un negocio?"_
- _"¿Hay alguna norma sobre mascotas?"_
- _"¿Qué dice la municipalidad sobre construcciones?"_

Si tu consulta es muy específica, te recomiendo contactar directamente al Concejo Deliberante:
📞 03751-480025

⚠️ _Mis respuestas son orientativas y no reemplazan el asesoramiento legal._`;
